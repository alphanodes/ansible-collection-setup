...
Ansible role to install and manage [MongoDB](https://www.mongodb.com/).
...
# Should be 4.0, 4.2, 4.4, 5.0 or 6.0.
...
# MMS Agent
mongodb_mms_agent_pkg: https://cloud.mongodb.com/download/agent/monitoring/mongodb-mms-monitoring-agent_latest_amd64.ubuntu1604.deb
