...
- [alphanodes.setup.certbot](roles/certbot/) [![certbot](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/certbot.yml/badge.svg)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/certbot.yml) [![dns](https://img.shields.io/github/actions/workflow/status/alphanodes/ansible-collection-setup/certbot_dns.yml?label=dns)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/certbot_dns.yml) [![nginx](https://img.shields.io/github/actions/workflow/status/alphanodes/ansible-collection-setup/certbot_nginx.yml?label=nginx)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/certbot_nginx.yml)
...
- [alphanodes.setup.dovecot](roles/dovecot/) [![dovecot](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/dovecot.yml/badge.svg)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/dovecot.yml) [![mail](https://img.shields.io/github/actions/workflow/status/alphanodes/ansible-collection-setup/mail.yml?label=mail)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/mail.yml)
...
- [alphanodes.setup.matomo](roles/matomo/) [![matomo](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/matomo.yml/badge.svg)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/matomo.yml) [![mariadb](https://img.shields.io/github/actions/workflow/status/alphanodes/ansible-collection-setup/matomo_mariadb.yml?label=mariadb)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/matomo_mariadb.yml)
...
- [alphanodes.setup.mysql](roles/mysql/) [![mysql](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/mysql.yml/badge.svg)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/mysql.yml) [![mariadb](https://img.shields.io/github/actions/workflow/status/alphanodes/ansible-collection-setup/mysql_mariadb.yml?label=mariadb)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/mysql_mariadb.yml)
...
- [alphanodes.setup.postfix](roles/postfix/) [![postfix](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/postfix.yml/badge.svg)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/postfix.yml) [![mail](https://img.shields.io/github/actions/workflow/status/alphanodes/ansible-collection-setup/mail.yml?label=mail)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/mail.yml)
...
- [alphanodes.setup.resolver](roles/resolver/) [![resolver](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/resolver.yml/badge.svg)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/resolver.yml)
...
- [alphanodes.setup.rspamd](roles/rspamd/) [![rspamd](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/rspamd.yml/badge.svg)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/rspamd.yml) [![mail](https://img.shields.io/github/actions/workflow/status/alphanodes/ansible-collection-setup/mail.yml?label=mail)](https://github.com/alphanodes/ansible-collection-setup/actions/workflows/mail.yml)
